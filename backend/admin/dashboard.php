...
<div class="sidebar d-flex flex-column">
    ...
    <div class="flex-grow-1">
        ...
        <?php if ($role === 'masyarakat') : ?>
            <a href="daftar_lelang.php"><i class="fas fa-list me-3 fa-fw"></i> Daftar Barang Lelang</a>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card border-0 shadow-sm p-4 rounded-4 bg-white">
                    <h3 class="fw-bold text-primary mb-3">Selamat Datang di Portal Lelang Umum</h3>
                    <p class="text-muted">Anda dapat melihat daftar barang yang sedang dilelang, mengajukan harga penawaran tertinggi, dan memantau status lelang secara real-time.</p>
                    <hr>
                    <div class="mt-2">
                        <a href="daftar_lelang.php" class="btn btn-primary px-4 py-2 fw-semibold">
